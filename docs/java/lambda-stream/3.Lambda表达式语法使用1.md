...
![1635596170901](../../.vuepress/public/images/1635596170901.png)

![1635596496925](../../.vuepress/public/images/1635596496925.png)
...
![1635596199350](../../.vuepress/public/images/1635596199350.png)
...
```
  -> 左边：lambda的形参列表的参数类型可以省略（类型推断）：如果参数列表只有一个参数，其一对（）也可以省略。
  
  -> 右边：lambda体应该使用{}来包裹：如果lambda只有一条执行语句（也可能是return语句），可以省略这一对{}和return关键字
  
  
  我们玩的这些都必须是函数式接口--都是只有一个实现
```
