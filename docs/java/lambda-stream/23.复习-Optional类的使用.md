...
​				之前是在Guava项目中最先使用的，然后java借鉴此优点

​				Optional《T》类（java.util.Optional）是一个容器类，他可以保存类型T的值，代表这个值存在。或者仅仅保存null，表示这个值不存在，现在Oprional可以更好的表达这个概念，并且可以避免空指针异常。
...
![1635868081443](../../.vuepress/public/images/1635868081443.png)
...
https://www.bilibili.com/video/BV1kk4y1R7AC?p=26&spm_id_from=pageDriver
