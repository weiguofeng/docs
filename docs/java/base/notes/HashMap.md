...
![1608657202572](../../../images/1608657202572.png)

### JDK1.8之后
相比于之前的版本，jdk1.8在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为8）时，将链表转化为红黑树，以减少搜索时间。

![1608657211800](../../../images/1608657211800.png)
...
## HashMap源码分析
### 构造方法
![1608657222224](../../../images/1608657222224.png)
```java
    // 默认构造函数。
    public HashMap() {
...
![1608657235582](../../../images/1608657235582.png)
